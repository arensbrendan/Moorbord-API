...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='X/Y in pixels';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO chair VALUES (3,10,30,2,6);
INSERT INTO chair VALUES (4,23,21,3,6);
...
CREATE TABLE class (
  ...
  KEY class_room_id_idx (room_id),
  CONSTRAINT class_room_id FOREIGN KEY (room_id) REFERENCES room (room_id),
...
INSERT INTO class VALUES (5,1,'crookery for dummies',1,NULL);
INSERT INTO class VALUES (6,1,'mathematics 1',2,NULL);
INSERT INTO class VALUES (7,NULL,'calculus 9000',5,NULL);
...
INSERT INTO log VALUES (29,'2023-01-20 21:29:17',1,'Login {\"username\": \"TU100001\", \"password\": \"passwd\"}');
...
CREATE TABLE room (
  ...
  PRIMARY KEY (room_id)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Length/Width in pixels';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO room VALUES (6,'Test',1925,12);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`admin`@`153.91.106.138` SQL SECURITY DEFINER VIEW select_all_admin AS select `user`.user_id AS user_id,`user`.username AS username,`user`.first_name AS first_name,`user`.last_name AS last_name,`user`.email AS email,`user`.phone_num AS phone_num,`user`.role_id AS role_id from (`user` join `admin` on((`admin`.user_id = `user`.user_id))) */;
...
/*!50001 SET character_set_results     = utf8mb4 */;
/*!50001 SET collation_connection      = utf8mb4_0900_ai_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`admin`@`153.91.106.138` SQL SECURITY DEFINER VIEW select_all_guardians AS select `user`.user_id AS user_id,`user`.username AS username,`user`.first_name AS first_name,`user`.last_name AS last_name,`user`.email AS email,`user`.phone_num AS phone_num,`user`.role_id AS role_id from (`user` join guardian on((guardian.user_id = `user`.user_id))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 SET character_set_results     = utf8mb4 */;
/*!50001 SET collation_connection      = utf8mb4_0900_ai_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`admin`@`153.91.106.138` SQL SECURITY DEFINER VIEW select_all_students AS select `user`.user_id AS user_id,`user`.username AS username,`user`.first_name AS first_name,`user`.last_name AS last_name,`user`.email AS email,`user`.phone_num AS phone_num,`user`.role_id AS role_id from (`user` join student on((student.user_id = `user`.user_id))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 SET character_set_results     = utf8mb4 */;
/*!50001 SET collation_connection      = utf8mb4_0900_ai_ci */;
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`admin`@`153.91.106.138` SQL SECURITY DEFINER VIEW select_all_teachers AS select `user`.user_id AS user_id,`user`.username AS username,`user`.first_name AS first_name,`user`.last_name AS last_name,`user`.email AS email,`user`.phone_num AS phone_num,`user`.role_id AS role_id from (`user` join teacher on((teacher.user_id = `user`.user_id))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-03-03 22:14:42
