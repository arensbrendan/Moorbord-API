...
class RoomCall(room_pb2_grpc.RoomCallServicer):
    ...
    def AddRoom(self, db, request, context):
        ...
        try:
            ...
            return room_pb2.AddRoomReply(message="The room has been added", status_code=200)
        except Exception as e:
            # Generic answer returns a 400
            return room_pb2.AddRoomReply(error=str(e), status_code=400)
    ...
    def RemoveRoom(self, db, request, context):
        ...
        try:
            ...
            if room_exists:
                ...
                db.execute(sql)
                return room_pb2.RemoveRoomReply(message="Room has been removed", status_code=200)
            else:
                raise ValueError("That room does not exists")
        except ValueError as v:
            return room_pb2.RemoveRoomReply(error=str(v), status_code=404)
        except Exception as e:
            return room_pb2.RemoveRoomReply(error=str(e), status_code=400)
